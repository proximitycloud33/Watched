...
import 'package:movie/presentation/widgets/recommendation_list.dart';
import 'package:movie/presentation/widgets/watchlist_button.dart';
...
class _MovieDetailPageState extends State<MovieDetailPage> {
  ...
  void initState() {
    ...
    Future.microtask(() {
      ...
      context.read<MovieDetailBloc>().add(FetchRecommendation(widget.id));
